...
class EvalDatasetGenerator:
    ...
    def __init__(
        ...
        """
        self.generator = TestsetGenerator.from_langchain(generator_llm, critic_llm, embeddings)
    ...
    async def generate_from_documents(
        ...
        """
        logger.info(
            "eval_dataset_generation_started", test_size=test_size, doc_count=len(documents)
        )
