...
async def test_search_mode_semantic():
    ...
    # Act
    results = await retriever.retrieve(query="test", tenant_id=uuid4(), search_type="semantic")
...
async def test_search_mode_literal():
    ...
    results = await retriever.retrieve(query="banana", tenant_id=uuid4(), search_type="literal")
...
async def test_similarity_threshold():
    ...
    results = await retriever.retrieve(query="test", tenant_id=uuid4(), similarity_threshold=0.5)
